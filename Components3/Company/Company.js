      ...
      <Drawer 
        ...
        <Link to="/company/nayeem" className={classes.link}>
          ...
          <div>
            ...
            <small >N.B. Give us email ,your company full descriptions so that we will add u our company page otherwise you only use our user page when u logged in.</small>
